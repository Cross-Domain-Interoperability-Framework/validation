...
The composite SHACL shapes are compiled from modular `rules.shacl` files in individual building blocks in the [metadataBuildingBlocks](https://github.com/usgin/metadataBuildingBlocks) repository. Two profiles are available:
