...
| `converters/DDICodebook/ddi25_to_cdif.py` | Thin **DDI Codebook 2.5** wrapper reusing `ddi122_to_cdif.py` (2.5 is an element-level superset of 1.2.2). See `converters/DDICodebook/README.md` |
