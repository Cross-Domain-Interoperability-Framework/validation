...
| `converters/DCAT/dcat_to_cdif.py` | Converts DCAT JSON-LD catalogs to CDIF schema.org format; `conformsTo` derived from content via detect_conformance (`--static-conformance` opts out). See `converters/DCAT/README.md` |
