...
| [`DDI-CDI/ddicdi_to_cdif.py`](DDI-CDI/ddicdi_to_cdif.py) | DDI-CDI 1.0 → CDIF *(phased; dataset, variables, code lists, structure, physical mappings, provenance done)* | DDI-CDI XML |
